...
def upgrade() -> None:
    ...
    op.create_table('investment_transactions',
        ...
        sa.Column('transaction_hash', sa.String(length=64), nullable=False),
        sa.Column('transaction_type', sa.Enum('BUY', 'SELL', 'DIVIDEND', 'INTEREST', 'FEE', 'TRANSFER', 'SPLIT', 'MERGER', 'SPINOFF', 'REINVESTMENT', name='investmenttransactiontype'), nullable=False),
